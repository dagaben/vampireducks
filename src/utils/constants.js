// Game constants – tuned for fun long sessions
...
export const DUCK_SPEED_BASE = 4.5;
export const DUCK_SPEED_NIGHT_MULT = 1.25;
export const DUCK_SPAWN_INTERVAL_DAY = 6.5; // seconds
export const DUCK_SPAWN_INTERVAL_NIGHT = 3.8;

export const DAY_LENGTH = 90; // seconds of day
export const NIGHT_LENGTH = 60; // seconds of night
